...
| `research/` | Research and analysis that informs design: background studies (`research/beets/`), synthesized design inputs (`research/teebs/`)                            | Reference: revised when re-researched, archived when stale |
